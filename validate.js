exports.Validate=(function V(){
	...
	if(Array.isArray(expressions)){
		...
		if(exp.result){
	    	...
	    	if(expressions.result){
		    _results=null;
		    if (typeof expressions.pass=='function')
			expressions.pass(expressions.message);
		}
		else{
		    _results=expressions.message;
		    if (typeof expressions.fail=='function')
			expressions.fail(expressions.message);
		}
